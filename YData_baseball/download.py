...
def download_data(file_name, save_in_directory = False):
...
def download_homework(homework_number, save_in_directory = False):
...
def download_problem_set(problem_set_number, save_in_directory = False):
...
def download_practice_code(practice_number, with_answers = False, save_in_directory = False):
...
def download_slides(class_number, save_in_directory = False):
...
def download_class_file(file_name, file_type, save_in_directory = False):
